...
// Las rutas asumen que los archivos están en '@/assets/'
import heroImage from "@/assets/hero-professional.jpg";

// Imágenes de Proyectos Rápidos (Prioridad Alta)
...
      {/* Gallery Preview Section - MODIFICADA para priorizar trabajos rápidos */}
      <section className="py-16 bg-secondary/50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-foreground mb-4">
...
                    Restauración de Fachada en Eixample
                  </h3>
                  <p className="text-muted-foreground mb-6">
                    Rescate completo de la seguridad y estética de un edificio histórico.
                  </p>
                  
                  <div className="space-y-4 text-sm">
                    <div>
                      <h4 className="font-semibold text-foreground mb-2">El Desafío: Seguridad y Patrimonio</h4>
                      <p className="text-muted-foreground">
                        Intervención delicada para resolver problemas de seguridad urgentes (desprendimientos) sin comprometer el valor histórico del edificio.
                      </p>
                    </div>
                    
                    <div>
                      <h4 className="font-semibold text-foreground mb-2">Nuestra Solución: Precisión y Calidad</h4>
                      <p className="text-muted-foreground">
                        Restauración completa de balcones, reconstrucción de molduras decorativas y uso de materiales de alta calidad para durabilidad y estética.
                      </p>
                    </div>
                  </div>
                </div>
...
                      <span className="font-medium">Antes:</span> Estado original. | <span className="font-medium">Después:</span> Fachada renovada.
                    </p>
