...
// --- ÚNICOS CAMBIOS: Importar las 3 imágenes de seguridad (en formato .jpeg) ---
...
const Gallery = () => {
  ...
  const sections = [
    // --- ÚNICO CAMBIO: Nueva sección para las fotos de seguridad ---
    {
      title: "Seguridad y Accesos",
      description: "Trabajos de seguridad preventiva en accesos.",
      projects: [
        {
          alt: "Seguridad Preventiva: Accesos",
          images: [
